...
class VulkanSwapchainContext {
 ...
 public:
  ...
  VulkanSwapchainContext(std::shared_ptr<vulkan::VulkanRenderingContext> vulkan_rendering_context, uint32_t capacity,
  ...
  void Draw(uint32_t image_index, std::shared_ptr<vulkan::VulkanRenderingPipeline> pipeline, uint32_t index_count,
