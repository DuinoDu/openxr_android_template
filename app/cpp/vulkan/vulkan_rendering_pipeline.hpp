...
class VulkanRenderingPipeline {
 ...
 public:
  ...
  VulkanRenderingPipeline(std::shared_ptr<VulkanRenderingContext> context, std::shared_ptr<VulkanShader> vertex_shader,
                          std::shared_ptr<VulkanShader> fragment_shader, const VertexBufferLayout &vbl,
