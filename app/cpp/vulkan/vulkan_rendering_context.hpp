...
namespace vulkan {
class VulkanRenderingContext : public std::enable_shared_from_this<VulkanRenderingContext> {
 private:
 ...
 public:
  VulkanRenderingContext(VkPhysicalDevice physical_device, VkDevice device, VkQueue graphics_queue,
  ...
  void CreateImage(uint32_t width, uint32_t height, VkSampleCountFlagBits num_samples, VkFormat format,
