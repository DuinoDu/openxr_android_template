...
vulkan::VulkanRenderingContext::VulkanRenderingContext(VkPhysicalDevice physical_device, VkDevice device,
...
VkDevice vulkan::VulkanRenderingContext::GetDevice() const { return device_; }

void vulkan::VulkanRenderingContext::WaitForGpuIdle() const { vkDeviceWaitIdle(device_); }

VkFormat vulkan::VulkanRenderingContext::FindSupportedFormat(const std::vector<VkFormat> &candidates,
...
void vulkan::VulkanRenderingContext::CreateImage(uint32_t width, uint32_t height, VkSampleCountFlagBits num_samples,
...
VkRenderPass vulkan::VulkanRenderingContext::GetRenderPass() const { return render_pass_; }

void vulkan::VulkanRenderingContext::TransitionImageLayout(VkImage image, VkImageLayout old_layout,
...
void vulkan::VulkanRenderingContext::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
...
void vulkan::VulkanRenderingContext::CopyBuffer(VkBuffer src_buffer, VkBuffer dst_buffer, VkDeviceSize size,
...
uint32_t vulkan::VulkanRenderingContext::FindMemoryType(uint32_t type_filter, VkMemoryPropertyFlags properties) const {
...
void vulkan::VulkanRenderingContext::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlagBits aspect_mask,
...
void vulkan::VulkanRenderingContext::EndSingleTimeCommands(VkQueue queue, VkCommandPool pool,
                                                           VkCommandBuffer command_buffer) {
...
vulkan::VulkanRenderingContext::~VulkanRenderingContext() { vkDestroyRenderPass(device_, render_pass_, nullptr); }

VkFormat vulkan::VulkanRenderingContext::GetDepthAttachmentFormat() const { return depth_attachment_format_; }
VkCommandPool vulkan::VulkanRenderingContext::GetGraphicsPool() const { return graphics_pool_; }
VkQueue vulkan::VulkanRenderingContext::GetGraphicsQueue() const { return graphics_queue_; }
